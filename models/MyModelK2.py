...
class ActorNetwork(nn.Module):
    ...
    def forward(self, x, user_type_onehot):
        ...
        user_tower_list = torch.concat([tower1_out,tower2_out], dim =2) #[bs,dim, 6]
...
class CriticNetwork(nn.Module):
    ...
    def forward(self, base_tower, labels, user_type_onehot):
        ...
        user_flag = user_type_onehot.unsqueeze(1)
        a_user_tower = torch.concat([tower1_out,tower2_out], dim =2)     #[bs,dim, 6]
...
class LiveRecoModelK2(nn.Module):
    def __init__(self, 
                 input_network = None,
                 base_output_dim = 128
                 ):
        super(LiveRecoModelK2, self).__init__()
