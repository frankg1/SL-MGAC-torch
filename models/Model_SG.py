...
class LiveRecoModelSG(nn.Module):
    # 去掉了stop gradient；让梯度可以传到base tower。
    def __init__(self, 
                 input_network = None,
                 base_output_dim = 128
                 ):
        super(LiveRecoModelSG, self).__init__()
    ...
    def forward(self, input):
        ...
        cur_action_logits = self.actor_network(cur_common_input_res, user_type_onehot)
