...
class TimeCriticNetwork(nn.Module):
    ...
    def forward(self, cur_x, nxt_x, cur_labels, nxt_labels, not_final, user_type_onehot):
        ...
        nxt_q1_value = self.target_network.critic1(nxt_x, nxt_labels, user_type_onehot)
        
        nxt_q2_value = self.target_network.critic2(nxt_x, nxt_labels, user_type_onehot)
...
class LiveRecoModelGrBuSl(nn.Module):
    def __init__(self, 
                 input_network = None,
                 base_output_dim = 128
                 ):
        super(LiveRecoModelGrBuSl, self).__init__()
    ...
    def forward(self, input):
        ...
        time_q_value1, time_rl_loss1 = self.time_critic1(cur_common_input_res, nxt_common_input_res, cur_labels, nxt_labels, not_final, user_type_onehot)
        
        time_q_value2, time_rl_loss2 = self.time_critic2(cur_common_input_res, nxt_common_input_res, cur_labels, nxt_labels, not_final, user_type_onehot)
