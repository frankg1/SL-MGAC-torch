...
class TimeCriticNetwork(nn.Module):
    ...
    def forward(self, cur_x, nxt_x, cur_labels, nxt_labels, not_final, user_type_onehot, target_network):
        ...
        nxt_q1_pred_reward, nxt_q1_pred_time_delta, nxt_q1_pred_live_time, nxt_q1_pred_photo_time, nxt_q1_value = target_network.critic1(nxt_x, nxt_labels, user_type_onehot)
        
        nxt_q2_pred_reward, nxt_q2_pred_time_delta, nxt_q2_pred_live_time, nxt_q2_pred_photo_time, nxt_q2_value = target_network.critic2(nxt_x, nxt_labels, user_type_onehot)
...
class LiveRecoModelGrBuCopy(nn.Module):
    def __init__(self, 
                 input_network = None,
                 base_output_dim = 128
                 ):
        super(LiveRecoModelGrBuCopy, self).__init__()
    ...
    def forward(self, input):
        ...
        time_q_value1, time_delta_sup_loss1, sup_loss1, time_rl_loss1 = self.time_critic1(cur_common_input_res, nxt_common_input_res, cur_labels, nxt_labels, not_final, user_type_onehot, self.time_critic2)
