...
from models.Model_GrCopy import LiveRecoModelGrCopy
from models.Model_GrLoss import LiveRecoModelGrLoss
from models.Model_GrBu import LiveRecoModelGrBu
from models.Model_GrBuCopy import LiveRecoModelGrBuCopy
...
from models.Model_SGQCopy import LiveRecoModelSGQCopy
from models.Model_SGQ import LiveRecoModelSGQ
from models.Model_NotQ import LiveRecoModelNotQ
from models.Model_SGSup import LiveRecoModelSGSup
...
model_mapping = {
    ...
    "Model_GrCopy": LiveRecoModelGrCopy,
    "Model_GrLoss": LiveRecoModelGrLoss,
    "Model_GrBu": LiveRecoModelGrBu,
    "Model_GrBuCopy": LiveRecoModelGrBuCopy,
    ...
    "Model_SGQCopy": LiveRecoModelSGQCopy,
    "Model_NotQ": LiveRecoModelNotQ,
    "Model_SGSup": LiveRecoModelSGSup
}
alabtion = True if args.model_name in ["Model","ModelK1","ModelK2","ModelK3","ModelK4","ModelK5",
                                       "Model_Gr","Model_GrBu","Model_GrBuSl","Model_LN","Model_SG",
                                       "Model_SQ","Model_SGQ", "Model_NotQ",
                                       "Model_SGSup","Model_GrBuSlCopy","Model_GrLoss",
                                        "Model_GrCopy", "Model_GrBuCopy", "Model_SGQCopy"
                                       ] else False
